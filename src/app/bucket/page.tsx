...
const Bucket = () => {
  const emptyBucket: Entities.Bucket = {
    description: "",
    name: "",
    aws_access_key_id: "",
      ...
      <React.Fragment>
        <div className="my-2">
          ...
          <Button
            ...
            disabled={!selectedBuckets || selectedBuckets === 0}
          />
        </div>
      </React.Fragment>
    );
    ...
    return (
      <>
        ...
        <Button
          ...
          rounded
          severity="warning"
          onClick={() => confirmDeleteBucket(rowData)}
        />
      </>
    );
  };
    ...
    <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
      ...
      <span className="block mt-2 md:mt-0 p-input-icon-left">
        ...
        <InputText
          ...
          placeholder="Encontrar um bucket..."
        />
      </span>
    </div>
  );
  ...
  const deleteBucket = async () => {
    const _selected = (buckets)?.filter(
      (val: Bucket) => val.id === bucket.id,
    );
    ...
    if (success) {
      ...
      toast.current?.show({
        severity: "error",
        summary: "Erro",
        detail: "Falha ao deletar um bucket",
        life: 3000,
      });
    }
  };
  ...
  const deleteBucketDialogFooter = (
    <>
      <Button
        ...
        icon="pi pi-times"
        text
        onClick={hideDeleteBucketDialog}
      />
  ...
  const deleteBucketsDialogFooter = (
    <>
      <Button
        ...
        icon="pi pi-times"
        text
        onClick={hideDeleteBucketsDialog}
      />
      <Button
        label="Sim"
        icon="pi pi-check"
        ...
        <div className="card">
          ...
          >
            ...
            <Column
              ...
              header="Ch. de acesso Id"
              sortable
              body={awsAccessKeyIdBodyTemplate}
              headerStyle={{ minWidth: "15rem" }}
            />
            <Column
              field="aws_secret_access_key"
              header="Ch. de acesso secreta"
              sortable
              body={awsSecretAccessKeyBodyTemplate}
              headerStyle={{ minWidth: "15rem" }}
            />
            <Column
              field="aws_region"
          ...
          >
            ...
            <div className="field">
              ...
              />
              {submitted && !bucket.name && (
                <small className="p-invalid">O nome é obrigatório.</small>
              )}
            </div>
            <div className="field">
              ...
              />
              {submitted && !bucket.aws_access_key_id && (
                <small className="p-invalid">
                  O Access key id é obrigatório.
                </small>
              )}
            </div>
            ...
            <div className="field">
              ...
              />
              {submitted && !bucket.aws_secret_access_key && (
                <small className="p-invalid">
                  O Secret access key é obrigatório.
                </small>
              )}
            </div>
            <div className="field">
          ...
          <Dialog
            visible={deleteBucketDialog}
            style={{ width: "450px" }}
            header="Confirme"
            modal
            footer={deleteBucketDialogFooter}
            onHide={hideDeleteBucketDialog}
          >
          ...
          <Dialog
            visible={deleteBucketsDialog}
            style={{ width: "450px" }}
            header="Confirme"
            modal
            footer={deleteBucketsDialogFooter}
            onHide={hideDeleteBucketDialog}
          >
            <div className="flex align-items-center justify-content-center">
              <i
